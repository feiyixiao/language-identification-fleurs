#!/usr/bin/env python3
# Fine-tune XLS-R (multilingual wav2vec2) on 8 FLEURS languages for language identification.
# Run: python train_xlsr.py
...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        ...
        logging_dir="./logs_xlsr",
        logging_steps=50,
        warmup_ratio=0.1,
        learning_rate=1e-5,          # smaller lr for larger model
        fp16=USE_FP16,
        push_to_hub=False,
    ...
    with open("../results/results_xlsr.txt", "w") as f:
        f.write("Method: XLS-R (wav2vec2-large-xlsr-53, fine-tuned)\n")
    ...
    print("Saved results/results_xlsr.txt")
