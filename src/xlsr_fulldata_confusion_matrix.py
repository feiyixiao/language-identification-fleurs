#!/usr/bin/env python3
# Generate confusion matrix for the XLS-R model fine-tuned on the full FLEURS train split.
...
CHECKPOINT    = "/fs/scratch/users/xiaofg/xlsr-fleurs-lid-fulldata/checkpoint-22128"  # best epoch (8)
...
np.save("../results/confusion_matrix_xlsr_fulldata.npy", cm)
print("Saved results/confusion_matrix_xlsr_fulldata.npy")
...
plt.ylabel("True")
plt.title("Confusion Matrix — XLS-R (full train split, test set)")
plt.tight_layout()
plt.savefig("../results/confusion_matrix_xlsr_fulldata.png", dpi=150)
print("Saved results/confusion_matrix_xlsr_fulldata.png")
