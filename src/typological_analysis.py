...
ax.set_title(f"Typological Distance vs. Confusion Rate — wav2vec2\nSpearman ρ = {rho:.3f}, p = {p:.3f}", fontsize=12)
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("../results/typological_analysis_wav2vec2.png", dpi=150)
print("Saved results/typological_analysis_wav2vec2.png")
plt.show()
